...
$(document).ready(function () {
    ...
    $(".contrast-white").click(function () {
        resetBG();
		$(".logos img").attr("src","images/logos_acc.png");
		$('body, #warper, #sec1, #sec2, #sec3, #sec4, h1 div').css('background', '#fff');
		$('.sec1SubTitle2, .topBar').css('background', 'none');
		$('.sec3GridBtn, .sec2 h2:before').css('background', '#ddd');
		$('h1, div, ul, .mainTitles span, .sec1SubTitle2 span, nav.top a, h2').css('color', '#000');
		$('.btnCircle').css('border', '1px solid #000');
		$('.accord, nav.top ul li.active').css('border-bottom', '4px solid #000');
		$('.aLink').css('color', '#000');
    ...
    $(".contrast-dark").click(function () {
        resetBG();		
		$('body, #warper, #sec1, #sec2, #sec3, #sec4, h1 div').css('background', '#000');
		$('.sec1SubTitle2, .topBar').css('background', 'none');
		$('.sec3GridBtn, .sec2 h2:before').css('background', '#333');
		$('h1, div, ul, .mainTitles span, .sec1SubTitle2 span, nav.top a, h2').css('color', '#fff');
		$('.btnCircle').css('border', '1px solid #fff');
		$('.accord, nav.top ul li.active').css('border-bottom', '4px solid #fff');
		$('.aLink').css('color', '#fff');
    });
    ...
    function resetBG() {
        $("*").each(function () {
            ...
            $(this).css("border", "");
			$(this).css("outline", "");
			$(".logos img").attr("src","images/logo.png");
        });
    }
